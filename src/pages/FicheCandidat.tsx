...
import { ConfidenceBadge, VerificationBadge } from '@/components/candidat/BadgeVerification'
import { LegalBlock } from '@/components/candidat/BlocJudiciaire'
import { candidateById, FAMILIES, CANDIDACY_STATUSES } from '@/data/candidats'
import { criteria, criteriaByFamily, criterionById } from '@/data/criteres'
