...
export const lisnard: Candidate = {
  id: 'lisnard',
  firstName: 'David',
  lastName: 'Lisnard',
  initials: 'DL',
  ...
  partyColor: '#1e7a8c',
  birth: '1969-06-05',
  currentRole: 'Maire de Cannes, président de Nouvelle Énergie',
  ...
  measures: [
    {
      id: 'lisnard-m1',
      themeId: 'fiscalite',
      title: 'Réduction de la dépense publique et des impôts de production',
      detail:
    ...
    },
    {
      ...
      title: 'Transfert de compétences et de fiscalité aux communes',
      detail:
    ...
    },
    {
      id: 'lisnard-m3',
      themeId: 'social',
      title: 'Refonte de l’école autour de l’accès au savoir',
      detail:
    ...
    },
    {
      id: 'lisnard-m4',
      themeId: 'securite',
      title: 'Recentrage de l’État sur ses missions régaliennes',
      detail:
  ...
  facts: [
    {
      id: 'lisnard-f1',
      date: '2026-03-31',
      title: 'Départ des Républicains et candidature déclarée',
      description:
    ...
    },
    {
      id: 'lisnard-f2',
      date: '2021-11',
      title: 'Élu président de l’Association des maires de France',
      description:
  ...
  legal: [],
  indicators: [
    { id: 'lisnard-i0', label: 'Recherche d’antécédents judiciaires', value: 'Effectuée, aucun élément trouvé', period: 'Au 20 août 2026', verification: 'recoupe', sourceIds: ['legifrance', 'courdecassation'] },
    { id: 'lisnard-i1', label: 'Années à la tête d’un exécutif local', value: 'Plus de 12 ans', period: '2014-2026', verification: 'a-verifier', sourceIds: ['vie-publique'] },
    { id: 'lisnard-i2', label: 'Intentions de vote au premier tour', value: '1 à 2 %', period: 'Printemps 2026', verification: 'a-verifier', sourceIds: ['jdd-candidats-2027'] },
  ],
